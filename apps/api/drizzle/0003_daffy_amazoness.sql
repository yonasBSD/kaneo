CREATE TABLE `time_entry` (
	...
	`created_at` integer DEFAULT '"2025-04-21T21:14:02.512Z"' NOT NULL,
...
CREATE TABLE `__new_project` (
	...
	`name` text NOT NULL,
	`description` text,
	`created_at` integer DEFAULT '"2025-04-21T21:14:02.511Z"' NOT NULL,
...
CREATE TABLE `__new_workspace_member` (
	...
	`joined_at` integer DEFAULT '"2025-04-21T21:14:02.511Z"' NOT NULL,
